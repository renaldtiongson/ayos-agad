...
<head>
    ...
    <title>Ayos Agad — Create Account</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Checkbox (kept for parity, unused on this page) */
        .custom-check {
    ...
    <div class="panel-left">
        ...
        <div style="position:relative; z-index:10; text-align:center;">
            ...
            <p style="color:rgba(255,255,255,0.70); font-size:0.82rem; margin-top:0.75rem; line-height:1.5;">
                Create an account to get instant access<br/>to trusted home service professionals.
            </p>
    ...
    <div class="panel-right">
        ...
        <div class="fu d1" style="margin-bottom:2rem;">
            <h2 style="font-size:1rem; font-weight:600; color:#1e3a5f;">
                <span style="color:var(--blue-700);">Create</span> Your Account
            </h2>
        </div>
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('register') }}" style="display:flex; flex-direction:column; gap:1.4rem;">
            @csrf
        ...
        @if (Route::has('home'))
            <p class="fu d7" style="text-align:center; font-size:0.78rem; color:#6b8fb5; margin-top:1.25rem;">
                Already have an account?&nbsp;
                <a href="{{ route('home') }}"
