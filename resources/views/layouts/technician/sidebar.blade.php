...
>
    ...
    <div class="relative z-10 flex items-center justify-between px-6 py-6">
        <a href="{{ route('technician_dashboard') }}" class="flex items-center gap-2.5">
    ...
    <nav class="relative z-10 flex-1 overflow-y-auto px-4 pb-4 space-y-1">
        ...
        <a href="{{ route('technician_dashboard') }}" class="nav-link {{ request()->routeIs('technician_dashboard') ? 'active' : '' }}">
