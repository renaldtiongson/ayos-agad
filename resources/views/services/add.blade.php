    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        ...
        <div class="border-b border-gray-200 px-6 py-4">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Fill in the details below to register a service.
            </p>
        </div>
            ...
            <form action="{{ route('admin.services.store') }}"
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
